...
import 'my_applications_model.dart';
export 'my_applications_model.dart';
...
class _MyApplicationsWidgetState extends State<MyApplicationsWidget> {
  late MyApplicationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyApplicationsModel());
  }
