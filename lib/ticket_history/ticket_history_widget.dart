                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      StreamBuilder<TotalServiceRecord>(
                                        stream: TotalServiceRecord.getDocument(
                                            widget.juu!),
                                        builder: (context, snapshot) {
                                          ...
                                          final richTextTotalServiceRecord =
                                              snapshot.data!;
                                          return RichText(
                                        ...
                                        child: Container(
                                          ...
                                          child: Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: StreamBuilder<
                                                  TotalServiceRecord>(
                                                stream: TotalServiceRecord
                                                    .getDocument(widget.juu!),
                                                builder: (context, snapshot) {
                                                  // Customize what your widget looks like when it's loading.
                                                  if (!snapshot.hasData) {
                                                    return Center(
                                                  ...
                                                  final textTotalServiceRecord =
                                                      snapshot.data!;
                                                  return Text(
                                                    textTotalServiceRecord.msg,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 12.0),
                                      child: StreamBuilder<TotalServiceRecord>(
                                        stream: TotalServiceRecord.getDocument(
                                            widget.juu!),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
