                                          ...
                                          return FlutterFlowDropDown<String>(
                                            controller: _model
                                                ...
                                                FormFieldController<String>(
                                                    null),
                                            options: dropDownServices2RecordList
                                                .map((e) => e.electrical)
                                                .toList(),
                                            onChanged: (val) => setState(() =>
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return FlutterFlowDropDown<String>(
                                            controller: _model
                                                ...
                                                FormFieldController<String>(
                                              _model.dropDownValue3 ??= 'N/A',
                                            ),
                                            options: dropDownServices3RecordList
                                                .map((e) => e.hardware)
                                                .toList(),
                                            onChanged: (val) => setState(() =>
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText: 'Enter enquiry/complaint',
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        var totalServiceRecordReference =
                                            TotalServiceRecord.collection.doc();
                                        await totalServiceRecordReference
                                            .set(createTotalServiceRecordData(
